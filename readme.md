...
<img src="https://laravel.com/assets/img/components/logo-laravel.svg" width="100" height="100">
</p>
<p align="center">
...
## Git
```bash
git clone http://git.qubit.tv:8888/vod/sas-laravel.git;
```
```bash
...
```bash
$ php -S localhost:8000 -t RUTA_ABSOLUTA/sas-laravel/public/
```
